...
"""
================================================================================
Notebook automate the ML predictions for pollutants.
...
Arguments:
  ...
  + preprocess_data: bool to determine if we want to preprocess input data or not
  + preprocess_data: bool to determine if we want to store predictions or not
