...
# In case we have different target variables i.e.: eRep and e1b.
  for target in trainset:
    ...
    duplicated_rows = data_handler.find_duplicates(df1=spark.createDataFrame(trainset), df2=spark.createDataFrame(testset), cols_to_compare=['Gridnum1km','date', 'hour', f'CAMS_{pollutant}', pollutant])
