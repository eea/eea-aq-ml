...
"""
================================================================================
Workflow of automatic up-to-date of CAMS Datasets to Azure Blob Storages.

Arguments:
  + downloading_date: Date of CAMS Dataset to work with.
    This Date is used as reference to download the CAMS Datastet with CDS API,
...
try:
    for notebook_name in ['cams2azure']:
        ...
        for i in range(delta_date_td.days + 1):
            ...
            result = dbutils.notebook.run(notebook_name, CHILD_TIMEOUT, {'date': date, 'delay': '0'})
