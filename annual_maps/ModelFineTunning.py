...
def bestModelParameters(pollutant):
...
#     sub = 0.9
    ...
    # Learning rate:  0.2 , max depth:  4 , gamma:  5.0 , alpha:  0.5 , lambda:  1.0 , subsample:  0.8
    lr = 0.2
    md = 4
    gm = 5.0
    al = 0.5
...
#     la = 2.0
#     sub = 0.9
  elif  pollutant == 'O3_SOMO35': # Learning rate:  0.1 , max depth:  5 , gamma:  0.5 , alpha:  0.5 , lambda:  1.0 , subsample:  0.8 #########################1
    lr = 0.1 #(2013-2020)
    md = 5
    gm = 0.5
    al = 0.5
...
#     la = 3.0
#     sub = 0.9
  elif  pollutant == 'O3_SOMO10': # Learning rate:  0.05 , max depth:  3 , gamma:  2.0 , alpha:  0.2 , lambda:  7.0 , subsample:  0.7 ##################
    lr = 0.05
    md = 3
    gm = 2.0
    al = 0.2
